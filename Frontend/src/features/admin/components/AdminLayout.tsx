  ...
  return (
    <div className="min-h-screen bg-slate-950 text-slate-100">
      <div className="mx-auto grid min-h-screen max-w-[1680px] lg:grid-cols-[280px_1fr]">
        <aside className="border-r border-white/10 bg-slate-900/80 p-5 backdrop-blur-xl">
        ...
        <div className="min-w-0">
          <header className="sticky top-0 z-10 border-b border-white/10 bg-slate-950/75 px-5 py-4 backdrop-blur-xl md:px-8">
